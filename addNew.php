    ...
    <div class="container">
        ...
        <?php include('error.php'); ?>
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control col-md-5" id="name" placeholder="Enter Employee Name" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded-0  col-md-5" id="address" rows="5" name="address" placeholder="Enter Address" ></textarea>
            </div>
